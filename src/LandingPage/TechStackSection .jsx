...
import { Code, Database, Server, ArrowRight, CheckCircle2, ExternalLink } from "lucide-react";
...
const TechStackSection = () => {
  ...
  const techStack = {
    frontend: {
      ...
      description: "Our frontend stack delivers performant and visually stunning user interfaces.",
      ...
      bgColor: "bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950/40 dark:to-blue-900/20",
      borderColor: "border-blue-200 dark:border-blue-800"
    },
    backend: {
      title: "Powerful Backend",
      description: "Our backend infrastructure ensures scalability and performance.",
      ...
      bgColor: "bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950/40 dark:to-green-900/20",
      borderColor: "border-green-200 dark:border-green-800"
    },
    deployment: {
      title: "Seamless Deployment",
      description: "Our DevOps practices ensure smooth delivery and maintenance.",
      ...
      bgColor: "bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950/40 dark:to-purple-900/20",
      borderColor: "border-purple-200 dark:border-purple-800"
    }
  };

  return (
    <section id="tech-stack" className="py-24 bg-zinc-50 dark:bg-zinc-950 overflow-hidden">
                      ...
                      >
                        <div 
                          className={`w-12 h-12 rounded-lg flex items-center justify-center mb-3 transition-colors duration-300 ${
                            hoveredTech === tech.name ? 'bg-yellow-100 dark:bg-yellow-900/30' : 'bg-zinc-100 dark:bg-zinc-700'
                          }`}
                        >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
                  ...
                  <div className="lg:col-span-3 flex flex-wrap justify-center gap-4 md:gap-6 p-6 bg-white/50 dark:bg-zinc-800/50 rounded-xl">
                    {category.technologies.map((tech, idx) => (
                      ...
                      >
                        <div className="w-10 h-10 rounded-lg bg-zinc-100 dark:bg-zinc-700 flex items-center justify-center mb-3">
          ...
          >
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-zinc-300 mb-8">
                Our experts can help you choose the right technologies for your project needs.
              </p>
